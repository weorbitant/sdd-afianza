...
description: "Refinamiento completo: fetch épica de Jira → designs → spec → clarify → checklist → preview HTML → push stories. Invocar con la clave de la Epic."
...
Ejecuta el ciclo de refinamiento: desde la Epic de Jira hasta las User Stories publicadas.
